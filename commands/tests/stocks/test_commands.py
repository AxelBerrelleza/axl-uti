...
def test_financials(requests_mock):
    requests_mock.get(
        "https://morning-star.p.rapidapi.com/stock/v2/get-financials", json={"mock": "financials"}
    )
...
def test_price_vs_fair_value(requests_mock):
    requests_mock.get(
        "https://morning-star.p.rapidapi.com/stock/v2/get-price-fair-value/",
        json={"mock": "fair_value"},
    )
...
def test_operating_efficiency(requests_mock):
    ...
    requests_mock.get(
        "https://morning-star.p.rapidapi.com/stock/v2/key-stats/get-operating-efficiency/",
        json=mock_data,
    )
